      ...
      <Card>
        <CardContent className="p-6 space-y-4">
          <div className="space-y-2">
            ...
            <Textarea
              id="description"
              placeholder="리노베이션 프로젝트에 대해 자세히 설명해주세요. 원하시는 결과, 특별한 요구사항, 선호하는 자재, 일정 제약, 특별한 고려사항 등을 포함해주세요..."
              value={description}
            ...
            {!isDescriptionValid && description.length > 0 && (
              <p className="text-sm text-red-600">
                업체가 프로젝트를 이해할 수 있도록 더 자세한 설명을 작성해주세요
              </p>
            )}
          </div>
        </CardContent>
        ...
        <CardContent className="p-6 space-y-4">
          <div className="space-y-2">
            <Label className="text-base font-medium">
              프로젝트 사진 (선택) / Project Photos (Optional)
            </Label>
            <p className="text-sm text-gray-600">
              현재 상태나 원하는 스타일 사진을 최대 {MAX_PHOTOS}장까지 업로드
            </p>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <p className="text-lg font-medium text-gray-900">
                  {photos.length >= MAX_PHOTOS ? '최대 사진 수 도달' : '사진을 드래그하거나 클릭하여 업로드'}
                </p>
                <p className="text-sm text-gray-600">
                  JPEG, PNG, WebP 형식 / 파일당 최대 10MB
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>• 현재 공간의 다양한 각도 사진을 포함하세요</li>
              <li>• 문제가 있는 부분을 보여주세요</li>
              <li>• 원하는 스타일 참고 사진을 추가하세요</li>
              <li>• 자세한 정보를 제공할수록 정확한 견적을 받을 수 있습니다</li>
            </ul>
          </div>
        </div>
      </div>
